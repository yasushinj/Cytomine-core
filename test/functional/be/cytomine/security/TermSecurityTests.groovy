...
class TermSecurityTests extends SecurityTestsAbstract {
    ...
    void testUpdateWhenOntologySharedBetweenProjects() {
        ...
        assert (403 == TermAPI.update(term.id,term.encodeAsJSON(),USERNAME1,PASSWORD1).code)
        assert (403 == TermAPI.delete(term.id,USERNAME1,PASSWORD1).code)
        assert (403 == TermAPI.create(term.encodeAsJSON(),USERNAME1,PASSWORD1).code)
